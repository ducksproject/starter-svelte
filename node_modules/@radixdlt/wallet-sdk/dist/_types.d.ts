...
import { SendTransactionMethod } from './methods/send-transaction';
...
export type Wallet = {
    requestItem: SendTransactionMethod['wallet']['request'] | RequestMethod['wallet']['request'];
    response: (RequestMethod['wallet']['response'] | SendTransactionMethod['wallet']['response'])[];
};
